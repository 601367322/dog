...
public enum DataType {
    ...
    /**
     * Persists the {@link java.math.BigInteger} Java class.
     */
    BIG_INTEGER(BigIntegerType.getSingleton()),
    /**
     * Persists the {@link java.math.BigDecimal} Java class as a String.
     */
    BIG_DECIMAL(BigDecimalStringType.getSingleton()),
    /**
     * Persists the {@link java.math.BigDecimal} Java class as a SQL NUMERIC.
     */
