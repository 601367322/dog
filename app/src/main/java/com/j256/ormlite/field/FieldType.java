...
/**
 * Per field information configured from the {@link DatabaseField} annotation and the associated {@link java.lang.reflect.Field} in the
...
public class FieldType {
    ...
    /**
     * You should use {@link com.j256.ormlite.field.FieldType#createFieldType} to instantiate one of these field if you have a {@link java.lang.reflect.Field}.
     */
     ...
     *
     * @see com.j256.ormlite.dao.BaseDaoImpl#initialize()
     */
     ...
     * {@link com.j256.ormlite.db.DatabaseType#isIdSequenceNeeded} is enabled. If the latter is true then the sequence name will be
     * auto-generated.
     */
    ...
    /**
     * Pass the foreign data argument to the foreign {@link com.j256.ormlite.dao.Dao#create(Object)} method.
     */
    ...
    /**
     * Return An instantiated {@link com.j256.ormlite.field.FieldType} or null if the field does not have a {@link DatabaseField} annotation.
     */
