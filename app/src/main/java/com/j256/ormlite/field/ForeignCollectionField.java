...
/**
 * Annotation that identifies a {@link com.j256.ormlite.dao.ForeignCollection} field in a class that corresponds to objects in a foreign
...
public @interface ForeignCollectionField {
     ...
     * {@link com.j256.ormlite.dao.LazyForeignCollection#iterator()} for more information.
     * </p>
     * <p/>
     * <p>
     ...
     * {@link com.j256.ormlite.dao.Dao#getEmptyForeignCollection(String)} or when you want to specify it in
     * {@link com.j256.ormlite.stmt.QueryBuilder#selectColumns(String...)}.
     */
