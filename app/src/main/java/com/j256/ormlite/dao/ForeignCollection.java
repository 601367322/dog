...
public interface ForeignCollection<T> extends Collection<T>, CloseableIterable<T> {
    ...
    /**
     * Like {@link java.util.Collection#iterator()} but while specifying flags for the results. This is necessary with certain
    ...
    /**
     * Like {@link java.util.Collection#iterator()} but returns a closeable iterator instead and can throw a SQLException.
     */
