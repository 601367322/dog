...
/**
 * Cache for ORMLite which stores objects with a {@link java.lang.ref.WeakReference} or {@link java.lang.ref.SoftReference} to them. Java Garbage
...
public class ReferenceObjectCache implements ObjectCache {
    ...
    /**
     * @param useWeak Set to true if you want the cache to use {@link java.lang.ref.WeakReference}. If false then the cache will use
    ...
    /**
     * Create and return an object cache using {@link java.lang.ref.WeakReference}.
     */
    ...
    /**
     * Create and return an object cache using {@link java.lang.ref.SoftReference}.
     */
