 ...
 * <p/>
 * <p>
 * <b>NOTE:</b> You must call {@link com.j256.ormlite.dao.CloseableIterator#close()} method when you are done otherwise the underlying SQL
...
public interface CloseableIterator<T> extends Iterator<T> {
     ...
     *
     * @throws java.sql.SQLException Throws a SQLException on error since {@link #next()} cannot throw because it is part of the
     *                               {@link java.util.Iterator} definition. It will <i>not</i> throw if there is no next.
     */
