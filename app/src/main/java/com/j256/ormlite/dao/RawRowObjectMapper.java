 ...
 * {@link Dao#queryRaw(String, DataType[], com.j256.ormlite.dao.RawRowObjectMapper, String...)} method.
 * <p/>
 * <p>
...
public interface RawRowObjectMapper<T> {
     ...
     *                      {@link Dao#queryRaw(String, DataType[], com.j256.ormlite.dao.RawRowObjectMapper, String...)}
     ...
     * @throws java.sql.SQLException If there is any critical error with the data and you want to stop the paging.
     */
