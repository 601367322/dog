...
public class RuntimeExceptionDao<T, ID> implements CloseableIterable<T> {
    ...
    /**
     * @see Dao#queryForFieldValues(java.util.Map)
     */
    ...
    /**
     * @see Dao#queryForFieldValuesArgs(java.util.Map)
     */
    ...
    /**
     * @see Dao#delete(java.util.Collection)
     */
    ...
    /**
     * @see Dao#deleteIds(java.util.Collection)
     */
    ...
    /**
     * @see Dao#callBatchTasks(java.util.concurrent.Callable)
     */
