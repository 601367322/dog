...
public class TransactionManager {
    ...
    /**
     * Execute the {@link java.util.concurrent.Callable} class inside of a transaction. If the callable returns then the transaction is
     * committed. If the callable throws an exception then the transaction is rolled back and a {@link java.sql.SQLException} is
     ...
     * @throws java.sql.SQLException If the callable threw an exception then the transaction is rolled back and a SQLException wraps the
    ...
    /**
     * Same as {@link #callInTransaction(java.util.concurrent.Callable)} except as a static method with a connection source.
     */
    ...
    /**
     * Same as {@link #callInTransaction(java.util.concurrent.Callable)} except as a static method on a connection.
     */
