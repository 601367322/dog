...
public class QueryBuilder<T, ID> extends StatementBuilder<T, ID> {
    ...
    /**
     * Build and return a prepared query that can be used by {@link com.j256.ormlite.dao.Dao#query(PreparedQuery)} or
     * {@link com.j256.ormlite.dao.Dao#iterator(PreparedQuery)} methods. If you change the where or make other calls you will need to re-call
     ...
     * only suitable for the {@link com.j256.ormlite.dao.Dao#queryRaw(String, String...)} type of statement. This can be called multiple
     ...
     * you should consider using the {@link com.j256.ormlite.dao.Dao#iterator()} method instead which handles paging with a database cursor.
     ...
     * {@link com.j256.ormlite.dao.Dao#countOf(PreparedQuery)}.
     * <p/>
     ...
     * {@link #joinOr(com.j256.ormlite.stmt.QueryBuilder)}.
     * </p>
     */
    ...
    /**
     * Like {@link #join(com.j256.ormlite.stmt.QueryBuilder)} but this combines the WHERE statements of two query builders with a SQL "OR".
     */
    ...
    /**
     * Similar to {@link #join(com.j256.ormlite.stmt.QueryBuilder)} but it will use "LEFT JOIN" instead.
     * <p/>
     ...
     * <p>
     * <b>NOTE:</b> This will do combine the WHERE statement of the two query builders with a SQL "AND". See
     * {@link #leftJoinOr(com.j256.ormlite.stmt.QueryBuilder)}.
     * </p>
     */
    ...
    /**
     * Like {@link #leftJoin(com.j256.ormlite.stmt.QueryBuilder)} but this combines the WHERE statements of two query builders with a SQL
     * "OR".
     */
    ...
    /**
     * A short cut to {@link com.j256.ormlite.dao.Dao#query(PreparedQuery)}.
     */
    ...
    /**
     * A short cut to {@link com.j256.ormlite.dao.Dao#queryRaw(String, String...)}.
     */
    ...
    /**
     * A short cut to {@link com.j256.ormlite.dao.Dao#queryForFirst(PreparedQuery)}.
     */
    ...
    /**
     * A short cut to {@link com.j256.ormlite.dao.Dao#queryRaw(String, String...)} and {@link com.j256.ormlite.dao.GenericRawResults#getFirstResult()}.
     */
    ...
    /**
     * A short cut to {@link com.j256.ormlite.dao.Dao#iterator(PreparedQuery)}.
     */
