...
public abstract class StatementBuilder<T, ID> {
    ...
    /**
     * Build and return all of the information about the prepared statement. See {@link com.j256.ormlite.stmt.StatementBuilder.StatementInfo} for more details.
     */
    ...
    /**
     * Get the result array from our statement after the {@link #appendStatementStart(StringBuilder, java.util.List)} was called.
