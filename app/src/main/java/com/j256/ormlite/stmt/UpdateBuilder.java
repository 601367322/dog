...
public class UpdateBuilder<T, ID> extends StatementBuilder<T, ID> {
    ...
    /**
     * Build and return a prepared update that can be used by {@link com.j256.ormlite.dao.Dao#update(PreparedUpdate)} method. If you change
    ...
    /**
     * A short cut to {@link com.j256.ormlite.dao.Dao#update(PreparedUpdate)}.
     */
