...
public class DeleteBuilder<T, ID> extends StatementBuilder<T, ID> {
    ...
    /**
     * Build and return a prepared delete that can be used by {@link com.j256.ormlite.dao.Dao#delete(PreparedDelete)} method. If you change
    ...
    /**
     * A short cut to {@link com.j256.ormlite.dao.Dao#delete(PreparedDelete)}.
     */
