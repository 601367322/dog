...
/**
 * Internal iterator so we can page through the class. This is used by the {@link com.j256.ormlite.dao.Dao#iterator} methods.
 *
...
public class SelectIterator<T, ID> implements CloseableIterator<T> {
     ...
     *
     * @throws java.sql.SQLException If there was a problem getting more results via SQL.
     */
     ...
     * @throws java.sql.SQLException If the delete failed.
     */
