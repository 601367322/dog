 ...
 * time.
 * <p/>
 * Every time you use the helper, you should call {@link #getHelper(android.content.Context)} or {@link #getHelper(android.content.Context, Class)}.
...
public class OpenHelperManager {
    ...
    /**
     * Similar to {@link #getHelper(android.content.Context, Class)} (which is recommended) except we have to find the helper class
     ...
     * </p>
     *
     * @deprecated Should use {@link #getHelper(android.content.Context, Class)}
     */
    @Deprecated
    ...
    /**
     * Release the helper that was previously returned by a call {@link #getHelper(android.content.Context)} or
     * {@link #getHelper(android.content.Context, Class)}. This will decrement the usage counter and close the helper if the counter is
     * 0.
     * <p/>
     * <p>
     ...
     * method if you expect to call {@link #getHelper(android.content.Context)} again before the application terminates.
     * </p>
     */
