package com.a.me.imid.swipebacklayout.lib;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    public void attachToActivity(Activity activity, boolean needAddParent) {
        mActivity = activity;
        ...
        decorChild.setBackgroundResource(R.color.white);

        if (needAddParent) {
            ViewGroup contentParent = (ViewGroup) decor.findViewById(android.R.id.content);

            ViewGroup layoutc = (ViewGroup) contentParent.getChildAt(0);
